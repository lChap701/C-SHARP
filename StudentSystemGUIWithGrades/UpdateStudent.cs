...
namespace StudentSystemGUI
{
    ...
    public partial class UpdateStudent : Form
    {
        ...
        public int orgId;   // used to store the original student ID of the student
        ...
        void Search_Click(object sender, EventArgs e)
        {
            ...
            if (errctr == 0)
            {
                ...
                {
                    if (stu.Id == int.Parse(stuId.Text))
                    {
                        if (stu.GetType() == typeof(Student) && stu.Id == int.Parse(stuId.Text))
                        {
                            liveOffCamp.Checked = true;

                            // Stores the original ID of this student
                            orgId = int.Parse(stuId.Text);
                        ...
                        else if (stu.GetType() == typeof(DormStudent))
                        {

                            DormStudent dormStu = (DormStudent)stu;

                            liveOnCamp.Checked = true;
                ...
                else
                {
                    ...
                    liveOnCampSection.Enabled = true;
        ...
        void UpdateStu()
        {
            ...
            if (errctr == 0)
            {
                ...
                {
                    // Attempts to create a new list without the student ID that was entered and stores the result in "stuList"
                    StudentSystem.stuList = StudentSystem.stuList.Where(s => s.Id != orgId).ToList();
        ...
        void DisableAndClear()
        {
            ...
            name.Text = "";
            liveOnCampSection.Enabled = false;

            if (liveOnCamp.Checked)
            {
                liveOnCamp.Checked = false;
            }
            else if (liveOffCamp.Checked)
            {
                liveOffCamp.Checked = false;
            }
