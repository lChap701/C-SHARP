        ...
        void Search_Click(object sender, EventArgs e)
        {
            ...
            if (errctr == 0)
            {
                foreach (var stu in StudentSystem.stuList)
                {
                    ...
                    else if (liveOnCamp.Checked)
                    {
                        if (stu.GetType() == typeof(DormStudent) && stu.Id == int.Parse(stuId.Text))
                        {
                            ...
                            {
                                MessageBox.Show("Dorm student was found!!", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information);
                ...
                if (!found)
                {
                    ...
                    {
                        MessageBox.Show("Dorm student was not found", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                }
                else
                {
