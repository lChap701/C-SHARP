...
using System.IO;
using DailyDiscussion;  // namespace used to use the Employee class file
class WriteSequentialFile
{
    static void Main()
    {
        ...
        FileStream outFile = new FileStream(FILENAME,   // creates the file and writes to it
           FileMode.Create, FileAccess.Write);
        StreamWriter writer = new StreamWriter(outFile);    // used to write data to the file
